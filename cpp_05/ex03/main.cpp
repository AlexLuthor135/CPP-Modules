...
/*   Updated: 2024/02/08 17:17:07 by alappas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "============== INTERN Tests! ==============" << std::endl << std::endl;

	Intern someRandomIntern;
	AForm* rrf;
	Bureaucrat *bob = NULL;
	rrf = someRandomIntern.makeForm("robot form", "Bender");
	try {bob = new Bureaucrat("Bob", 40);}
